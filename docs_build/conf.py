...
project = 'komanawa-easy-nc-accessor'
light_name = 'Easy-Nc-Accessor'
project_dirname=light_name.lower().replace('-', '_')
...
extensions = ['sphinx.ext.todo', 'autoapi.extension', 'sphinx.ext.autodoc',
...
html_theme_options = {
    ...
    "logo": {
        ...
        "text": f"{light_name.lower().title()} {release} Overview",
    },
    "show_toc_level": 2,
    ...
    "icon_links": [
        {
            "name": "View on GitHub",
            "url": "#https://github.com/Komanawa/komanawa-easy-nc-accessor#",
